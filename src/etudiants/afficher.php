                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        <a href="../relevez/afficher.php?id=<?= $etudiant['id'] ?>"
                                            class="px-3 py-1 text-sm font-semibold text-orange-700 bg-orange-100 rounded-md hover:bg-orange-200 transition">
