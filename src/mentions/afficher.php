            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php foreach ($notes as $note): 
                        $mention = getMention($note['min_val']);
                    ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 text-center font-medium text-gray-900"><?= $note['id'] ?></td>
                            <td class="px-6 py-4 text-center"><?= $note["min_val"] ?></td>
                            <td class="px-6 py-4 text-center"><?= $note["max_val"] ?></td>
                            <td class="px-6 py-4 text-center font-semibold text-blue-700"><?= $mention ?></td>
                        </tr>
                    <?php endforeach; ?>
                    <?php if (empty($notes)): ?>
                        <tr>
