...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update = $pdo->prepare("UPDATE mentions SET min_val = ?, max_val = ?, libelle = ? WHERE id = ?");
    $update->execute([$min_value, $max_value, $libelle, $id]);
...
<section class="min-h-screen pt-32 pb-16">
    <div class="max-w-3xl mx-auto px-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <h2 class="text-2xl font-extrabold text-blue-900 mb-6 text-center">Modifier la Mention</h2>
            ...
            <form method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="min_value" required
                        value="<?= htmlspecialchars($mention['min_val']) ?>"
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="max_value" required
                        value="<?= htmlspecialchars($mention['max_val']) ?>"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="libelle" required
                        value="<?= htmlspecialchars($mention['libelle']) ?>"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
